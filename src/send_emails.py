...
from scraping_app.models import Vacancy, Error, Url
from scraping.settings import EMAIL_HOST_USER, EMAIL_HOST, EMAIL_HOST_PASSWORD
...
if qs.exists():
    ...
    if data:
        ...
        for i in data:
            _html += f'<p>Город: {i["city"]}, Язык программирования: {i["language"]}, Почта: {i["email"]}</p><br>'
